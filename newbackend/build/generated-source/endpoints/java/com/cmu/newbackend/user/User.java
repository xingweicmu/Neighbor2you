 ...
 * on 2015-04-28 at 04:38:28 UTC 
 * Modify at your own risk.
 */

package com.cmu.newbackend.user;
...
public class User extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.20.0 of the user library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   *
   * @param content the {@link com.cmu.newbackend.user.model.User}
   * @return the request
   */
  public Authenticate authenticate(com.cmu.newbackend.user.model.User content) throws java.io.IOException {
    Authenticate result = new Authenticate(content);
    initialize(result);
    return result;
  }

  public class Authenticate extends UserRequest<com.cmu.newbackend.user.model.User> {
     ...
     * parameters, call the {@link Authenticate#execute()} method to invoke the remote operation. <p>
     * {@link
     ...
     * @since 1.13
     */
    protected Authenticate(com.cmu.newbackend.user.model.User content) {
      super(User.this, "POST", REST_PATH, content, com.cmu.newbackend.user.model.User.class);
    }
  ...
  public class ListUser extends UserRequest<com.cmu.newbackend.user.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(User.this, "GET", REST_PATH, null, com.cmu.newbackend.user.model.CollectionResponseUser.class);
    }
  ...
  public class RemoveUser extends UserRequest<Void> {
   ...
   * @return the request
   */
  public SignUp signUp(com.cmu.newbackend.user.model.User content) throws java.io.IOException {
    SignUp result = new SignUp(content);
    initialize(result);
    return result;
  }

  public class SignUp extends UserRequest<com.cmu.newbackend.user.model.User> {
     ...
     * @since 1.13
     */
    protected SignUp(com.cmu.newbackend.user.model.User content) {
      super(User.this, "POST", REST_PATH, content, com.cmu.newbackend.user.model.User.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.cmu.newbackend.user.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserRequest<com.cmu.newbackend.user.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.cmu.newbackend.user.model.User content) {
      super(User.this, "PUT", REST_PATH, content, com.cmu.newbackend.user.model.User.class);
    }
